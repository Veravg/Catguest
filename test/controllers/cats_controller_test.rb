...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { age: @cat.age, color: @cat.color, gender: @cat.gender, image_url: @cat.image_url, name: @cat.name, price: @cat.price } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { age: @cat.age, color: @cat.color, gender: @cat.gender, image_url: @cat.image_url, name: @cat.name, price: @cat.price } }
